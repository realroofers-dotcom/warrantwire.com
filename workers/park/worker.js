...
export default {
  async fetch(request) {
    ...
    /* every host to its own card, as typed. The marketplace matches a name on
       any spelling (live since 20 Sep) and, for a name it does not hold,
       searches for it. No table, no exceptions. */
